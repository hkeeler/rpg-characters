...
|---------------------------------------------------------------------|-------|------|-------|---------|-----------|-----------|
| [Acrobatics](http://www.d20pfsrd.com/skills/acrobatics)             |  26   |  14  |   3   | 4 (Dex) |  +5 (Boots) + 14 (Jump) |     Y     |
...
On full-attack action with at least one unarmed strike, make two extra unarmed strikes at your highest base attack bonus. Must be made against a dazed, flat-footed, paralyzed, staggered, stunned, or unconscious foe
...
- Must move at least 10 feet in a straight line before attacking.a
...
- Lore Keeper (Sp): You can touch a creature to learn about its abilities and weaknesses. With a successful touch attack,
  you gain information as if you made the appropriate Knowledge skill check with a result equal to 15 + your cleric level + your Wisdom modifier.
...
- Agile Feet (Su): As a free action, you can gain increased mobility for 1 round. For the next round, you ignore all difficult terrain and do not take
  any penalties for moving through it. You can use this ability a number of times per day equal to 3 + your Wisdom modifier.
...
- Wand of Cure Light Wounds (1D8+5) (0 Charges) (750 gp)
...
## 3.5 to Pathfinder Conversion Notes
- Added +2 to Wisdon for being a Human
- TODO: Make sure feats selected match correct Monk bonus feats
- 1st:  Deflect Arrows
- 2nd:  Dodge
- 4th:  ???
- 6th:  Improved Disarm
- 10th: ???
- Adjusted “Flurry of Blows” attack bonus
- Added new features to “Stunning Fist”
- Added +1 AC 
- Added “Maneuver Training” class feature
- Added “Ki Pool” class feature 
- Added “High Jump” class feature
- Updated “Wholeness of Body” class feature to use Ki points
- Updated “Abundant Step” class feature to use Ki points
- Recalculate Skills:
    ```
    Monk:   104 = 13 * 8( 4 (Base) + 2 (Int) + 1 (Human) +1 (Favored) )
    Cleric:   5 =  1 * 5( 2 (Base) + 2 (Int) + 1 (Human) )
    Total:  109
    ```


TODO:
Add all level 14th level skills
Check all other stats for updated level
Update Conversion notes.
Add more links to document.
Calculate value of items: 107,750 gp (185,000 available)
Make sure HP is correct for 14th level.
